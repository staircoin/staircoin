...
// Copyright (c) 2014-2015 The Stair and PIVX Core Developers
...
BOOST_AUTO_TEST_CASE(netbase_splithost)
{
    ...
    BOOST_CHECK(TestSplitHost("127.0.0.1:41061", "127.0.0.1", 41061));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:41061", "127.0.0.1", 41061));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:41061", "::ffff:127.0.0.1", 41061));
    BOOST_CHECK(TestSplitHost("[::]:41061", "::", 41061));
    BOOST_CHECK(TestSplitHost("::41061", "::41061", -1));
    BOOST_CHECK(TestSplitHost(":41061", "", 41061));
    BOOST_CHECK(TestSplitHost("[]:41061", "", 41061));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:41061", "127.0.0.1:41061"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:41061", "[::]:41061"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
