...
#if defined(NDEBUG)
#error "STAIR cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "STAIR Signed Message:\n";
...
int64_t GetBlockValue(int nHeight)
{
	...
	else if (nHeight > 1 && nHeight <= 4320) {nSubsidy = 0.4 * COIN;} 
	else if (nHeight > 4320) {nSubsidy = 20 * COIN;} 
/*	else if (nHeight > 14401 && nHeight <= 24482) {nSubsidy = 60 * COIN;} 
	else if (nHeight > 24482 && nHeight <= 34563) {nSubsidy = 120 * COIN;} 
	else if (nHeight > 34563 && nHeight <= 44644) {nSubsidy = 200 * COIN;} 
	else if (nHeight > 44644 && nHeight <= 1000000) {nSubsidy = 300 * COIN;} 
	else if (nHeight > 1000000) {nSubsidy = 200 * COIN;}*/
    return nSubsidy;
}
