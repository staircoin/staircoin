...
/** Utility functions used by the STAIR Qt UI.
 */
namespace GUIUtil
{
...
// Render STAIR addresses in monospace font
...
// Parse "stair:" URI into recipient object, return true on successful parsing
