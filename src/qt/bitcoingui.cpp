                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("STAIR-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a STAIR address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and stair: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About STAIR Core"), this);
    aboutAction->setStatusTip(tr("Show information about STAIR Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for STAIR"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your STAIR addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified STAIR addresses"));
    ...
    openAction->setStatusTip(tr("Open a STAIR: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the STAIR Core help message to get a list with possible STAIR command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("STAIR Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to STAIR network", "", count));
}
...
{
    QString strTitle = tr("STAIR Core"); // default title
