...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* STAIR features */
        {"stair", "masternode", &masternode, true, true, false},
        {"stair", "masternodelist", &masternodelist, true, true, false},
        {"stair", "mnbudget", &mnbudget, true, true, false},
        {"stair", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"stair", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"stair", "mnsync", &mnsync, true, true, false},
        {"stair", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use staird, or the -server option to stair-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> stair-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:41062/\n";
}
